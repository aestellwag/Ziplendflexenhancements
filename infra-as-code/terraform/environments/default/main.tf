...
module "studio" {
  ...
  workflow_sid_incoming_live_transfers = module.taskrouter.workflow_incoming_live_transfers_sid
  workflow_sid_direct_line = module.taskrouter.workflow_direct_line_sid
