...
module "studio" {
  ...
  workflow_sid_incoming_live_transfers = module.taskrouter.workflow_sid_incoming_live_transfers
  workflow_sid_direct_line = module.taskrouter.workflow_sid_direct_line
